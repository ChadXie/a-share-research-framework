...
仓库 `examples/` 目录提供一份完整示例（以中际旭创 300308 为例），演示框架的完整产出：

- `中际旭创_投研可视化.html` — 可视化研究报告（8 阶段流水线 + 财务增长图 + 催化表 + 产业链地图 + UZI 四象限 + 风控预警）
- `中际旭创_投研决策备忘录.md` — 文本版备忘录（8 阶段全产物）
- `投研决策备忘录_模板.md` — 可复用的空白模板，套用你自己的标的
